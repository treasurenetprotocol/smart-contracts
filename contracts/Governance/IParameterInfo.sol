...
interface IParameterInfo {
    ...
    function getUSTNLoanPledgeRateWarningValue() external view returns (uint256 amount);
    function getUSTNLoanLiquidationRate() external view returns (uint256 amount);
