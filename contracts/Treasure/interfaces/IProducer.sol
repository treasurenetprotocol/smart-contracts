...
interface IProducer is IShare {
    ...
    event Link(bytes32 key, bytes32[] uniqueIds, uint256[] ratios, string[] nicknames, bytes32 dappId);
     ...
     */
    function getProducer(bytes32 _uniqueId) external view returns (ProducerStatus, ProducerCore memory);
