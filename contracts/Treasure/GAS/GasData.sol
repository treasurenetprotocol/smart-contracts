...
contract GasData is ProductionData {
    ...
    /**
     * @dev Receives trusted production data from the oracle.
     * @param _requestId The request ID generated by the oracle.
     * @param _uniqueId The unique ID of the production data.
     * @param _produceData The production data received from the oracle.
     */
