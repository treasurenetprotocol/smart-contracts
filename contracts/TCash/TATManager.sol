...
contract TATManager is Initializable, OwnableUpgradeable {
    ...
    // Set user's TAT mint count (admin only)
    ...
    // Set user's 3-month average of unused TAT (admin only)
