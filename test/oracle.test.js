...
describe('Oracle', () => {
  it('restricts feeder and foundation manager roles', async () => {
  ...
  it('handles oracle request lifecycle and parameter validation', async () => {
    const { accounts, oracle } = await loadFixture(deployCoreFixture);
  ...
  it('manages supported symbols and prices', async () => {
    const { accounts, oracle } = await loadFixture(deployCoreFixture);
  ...
  it('locks and unlocks TCASH minting based on price movement', async () => {
    const { accounts, oracle } = await loadFixture(deployCoreFixture);
