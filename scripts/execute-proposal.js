...
async function executeProposal() {
    try {
        console.log('Executing Multisig Proposal');
        console.log('===========================');
        console.log(`Proposal ID: ${CONFIG.PROPOSAL_ID}`);
        console.log(`Executor: ${CONFIG.EXECUTOR_ADDRESS}`);
        console.log('');
        ...
        console.log('✅ Executor is a foundation manager');
        ...
        console.log('✅ Proposal has enough signatures');
        ...
        try {
            ...
            console.log('⚠️  Cannot get proposal details (might be executed or deleted)');
        }
        ...
        if (receipt.events && receipt.events.ProposalExecuted) {
            console.log(`   Event: ProposalExecuted(${receipt.events.ProposalExecuted.returnValues.proposalId})`);
        }

        console.log('');
        console.log('✅ DApp registration completed!');
        console.log('   DApp "OtterStreamTest" has been registered to OIL resource');
        console.log('   Payee address: 0x1234567890123456789012345678901234567891');
        ...
        if (parseInt(newSignatureCount) === 0) {
            console.log('✅ Proposal has been removed from pending list');
        } else {
            console.log('⚠️  Proposal might still be in system (this could be normal)');
        }
