...
class ContractCaller {
  ...
  static async callContractMethod(params) {
    ...
    logger.info('🚀 Starting contract call...');
    logger.info(`   Contract: ${contractAddress}`);
    logger.info(`   Method: ${methodSignature}`);
    logger.info(`   Params: [${methodParams.join(', ')}]`);
  ...
  static async signTransaction(txData) {
    ...
    const { messageHash } = tempSignedTx;
 ...
 */
async function main() {
  logger.info('🚀 KMS contract caller starting...');
  logger.info('=====================================\n');
